            ...
            <div>
                {
                    ...
                    (<img style={{width: 128, height: 128}} src={this.state.listImg[0]} alt={this.props.title} />) :
                    (<img style={{width: 128, height: 128}} src={this.props.imgCategory} alt={this.props.title} />)
                }
            </div>
        )
    }
